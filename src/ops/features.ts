...
import { featuresByAct, featuresOf, Modification, ModificationPurpose, RollCopy, statesNothing } from "../model/RollCopy.js"
import { ReferenceAssumption, idOf } from "../model/Assumption.js"
import { AnyFeature, FeatureConditionAssignment, FeatureConditionType, FeatureOrPatch, HorizontalSpan, NestedFeature, Patch, conditions as conditionsAllowed, featuresBorneBy, isPatch, withBorneFeatures } from "../model/Feature.js"
